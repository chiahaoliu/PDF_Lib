...
class PdfLibBuild(object):
    ...
    def build_lib(self, crystal_system, save_gr = True, size_limit=None):
        ...
        save_gr : bol
            option of save calculated gr data. Usually it is not required
        size_list : int
        ...
        gr_list_name = '{}_{}_Gr.txt'.format(crystal_system, time_info)
        gr_list_w_name = os.path.join(data_dir, gr_list_name)
        np.savetext(gr_list_w_name, gr_list)
        space_group_symbol_list_name = '{}_{}_SpaceGroupSymbol.txt'.format(crystal_system, time_info)
        space_group_symbol_list_w_name= os.path.join(data_dir, space_group_symbol_list_name)
        np.savetext(space_group_symbol_list_w_name, space_group_symbol_list)
        el_list_name = '{}_{}_Element.txt'.format(crystal_system, time_info)
        el_list_w_name = os.path.join(data_dir, el_list_name)
        np.savetext(el_list_w_name, el_list)
